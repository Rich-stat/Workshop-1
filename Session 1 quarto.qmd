...
Once packages are installed you call them by using the `library()` function:<br> *NB* You need to do this every time you start a new session.
...
- You have already created a project called **'LS5022 Biostatistics'** in Posit Cloud. Now create a new folder within the project called 'Session 1' where we will store today's work.
