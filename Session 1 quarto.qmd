...
-   Select the blue icon in the top right corner that says '**New Project**'. Create a new RStudio project called '**LS5022 Biostatistics**' (you are allowed 25 projects on the free plan). It is here that we will work and save our files in all of the workshops. <br>
...
#| column: page-right
#| lightbox: true
knitr::include_graphics("RStudio page.png")
```
